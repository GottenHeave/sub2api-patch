...
// IsVoiceInkProbe identifies the invalid connection-test payload emitted by VoiceInk.
func (r *OpenAIAudioTranscriptionsRequest) IsVoiceInkProbe() bool {
	return r != nil && strings.EqualFold(strings.TrimSpace(r.FileName), "probe.wav") && r.FileSizeBytes == 1024
}
