...
func init() {
	...
	usagelogDescAudioInputTokens := usagelogFields[19].Descriptor()
	...
	usagelogDescAudioOutputTokens := usagelogFields[20].Descriptor()
	...
	usagelogDescAudioCacheCreationTokens := usagelogFields[21].Descriptor()
	...
	usagelogDescAudioCacheReadTokens := usagelogFields[22].Descriptor()
