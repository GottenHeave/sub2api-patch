      ...
      <div class="whitespace-nowrap rounded-lg border border-gray-700 bg-gray-900 px-3 py-2.5 text-xs text-white shadow-xl dark:border-gray-600 dark:bg-gray-800">
        <div class="space-y-1.5">
          <div>
            ...
            <div v-if="tokenTooltipData && visibleInputTokens(tokenTooltipData) > 0 && !hasImageInputTokens(tokenTooltipData)" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.inputTokens') }}</span>
              <span class="font-medium text-white">{{ visibleInputTokens(tokenTooltipData).toLocaleString() }}</span>
            </div>
            <div v-if="tokenTooltipData && hasImageInputTokens(tokenTooltipData) && visibleInputTokens(tokenTooltipData) - tokenTooltipData.image_input_tokens > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.inputTokens') }}</span>
              <span class="font-medium text-white">{{ (visibleInputTokens(tokenTooltipData) - tokenTooltipData.image_input_tokens).toLocaleString() }}</span>
            </div>
            ...
            <div v-if="tokenTooltipData && visibleOutputTokens(tokenTooltipData) > 0 && !hasImageOutputTokens(tokenTooltipData)" class="flex items-center justify-between gap-4">
